...
sentinel2 = Raster("/home/gueneau/Documents/FOTO_Clustering_T16/clip_sentinel2.tif")
result_raster = Raster.raster_calculation([sentinel2, label_raster], partial(set_no_data, label=0, no_data=-999), no_data=-999)
